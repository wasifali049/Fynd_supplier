...
if (isset($_REQUEST['rfq']) && !empty($_REQUEST['rfq'])) {
...
$sql = "SELECT * FROM `inquiry_offer` WHERE {$cond} ORDER BY id DESC LIMIT $startFrom, $limit";
...
<head>
    <title>Manage Inquiry / Offer Page Seo - <?= BRANDNAME ?> Admin Panel</title>
                            ...
                            <div class="col-md-8">
                                <form action="">
                                    <div class="form-group d-flex justify-content-between">
                                        <input type="text" class="form-control" name="rfq" placeholder="Search RFQ" value="<?= $rfq ?>" required>
                                        <input type="submit" name="submit" class="btn btn-primary mx-1" value="Search" />
                                        <a href="./inquiry-offer-page-seo.php" class="btn btn-danger">Clear</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="inquiry-offer-page-seo-update.php?id=<?= $chatValue->id ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                                                ...
                                                <td><?= $chatValue->chemical ?></td>
                                                <td><?= $chatValue->email ?></td>
                                                <td><?= $chatValue->mobile ?></td>
                                                <td><?= $chatValue->type ?></td>
                                                <td><?= $chatValue->rfq ?></td>
                                            </tr>
                                        <?php $j++;
                                        }
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm">
                                    ...
                                    for ($i = 1; $i <= $total_pages; $i++) {
                                        if ($i == $pn) {
                                            $pagLink .= "<li class='page-item disabled active'><a class='page-link' href='inquiry-offer-page-seo.php?page="

                                                . $i . "'>" . $i . "</a></li>";
                                        } else {
                                            $pagLink .= "<li class='page-item'><a class='page-link' href='inquiry-offer-page-seo.php?page=" . $i . "'>
