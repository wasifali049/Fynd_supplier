...
$model = fetch_all($db, "SELECT * FROM `inquiry_offer` WHERE type='offer' AND status=1 ORDER BY id DESC");
$offerAlignment = fetch_object($db, "SELECT * FROM `offer_alignment` WHERE id='{$id}'");
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($db, $s)) {
        $error .= "Offer Alignment saved successfully";
        header('location: offer-all.php?msg=' . $error . '&alert=success');
    } else {
        $error .= "Internal Server Error.";
        header('location: offer-alignment-edit.php?id=' . $id . '&msg=' . $error . '&alert=danger');
    }
}
...
<head>
    <title>Add Send Offers to Buyers Alignment - <?= BRANDNAME ?> Admin Panel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Send Offers to Buyers Alignment Page</h1>
                    </div>
                            ...
                            <form action="" method="post">
                                <div class="my-3">
                                    ...
                                    <div class="border rounded shadow p-3 my-3">
                                        <h3 class="mb-2">Offer Alignment</h3>
                                        <hr>
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box1" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey1 => $userVal1) {
                                                    ...
                                                    $selected1 = ($offerAlignment->box1 == $userValue1->id) ? 'selected' : '';
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box2" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey2 => $userVal2) {
                                                    ...
                                                    $selected2 = ($offerAlignment->box2 == $userValue2->id) ? 'selected' : '';
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box3" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey3 => $userVal3) {
                                                    ...
                                                    $selected3 = ($offerAlignment->box3 == $userValue3->id) ? 'selected' : '';
