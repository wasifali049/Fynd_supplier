...
$model = fetch_all($db, "SELECT * FROM `faq`");
...
<head>
    <title>Manage FAQ - <?= BRANDNAME ?> Admin Panel</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row my-4">
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <a href="./faq-add.php" class="btn btn-success btn-sm">
                    ...
                    <div class="col-12" style="width:100%;overflow: auto;">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="faq-title-edit.php?id=<?= $faqTitle->id ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                                                <i class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                                                Edit
                                            </a>
                                        </td>
                                        <td><?= $faqTitle->title ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    if (count($model) > 0) {
                                        ...
                                        foreach ($model as $key => $value) { ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="faq-update.php?id=<?= $value['id'] ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                                                        <i class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                                                        Edit
                                                    </a>

                                                    <a data-toggle="modal" data-target="#deleteModal" href="#" data-url="faq-delete.php?id=<?= $value['id'] ?>" class="mx-1 my-1 btn btn-sm btn-danger image-delete-btn">
