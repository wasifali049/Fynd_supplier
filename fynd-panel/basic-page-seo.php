...
$model = fetch_all($db, "SELECT * FROM `seo` ORDER BY id DESC LIMIT $startFrom, $limit");
...
<head>
    <title>Manage Basic Page Seo - <?= BRANDNAME ?> Admin Panel</title>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="basic-page-seo-update.php?id=<?= $chatValue->id ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                                                ...
                                                <td><?= $chatValue->title ?></td>
                                                <td><?= $chatValue->description ?></td>
                                                <td><?= $chatValue->keyword ?></td>
                                                <td><?= $chatValue->page ?></td>
                                            </tr>
                                        <?php $j++;
                                        }
                                    } else { ?>
