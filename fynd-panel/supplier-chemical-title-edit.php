...
$model = fetch_object($db, "SELECT * FROM `chemical_title`");
...
if (isset($_POST['submit'])) {
    ...
    $s = "UPDATE `chemical_title` SET `title`='{$title}', `updated_at`='{$updated_at}' WHERE id='{$edit_id}'";

    if (mysqli_query($db, $s)) {
        $error .= "Chemical Title Updated successfully.";
        header('location: supplier-chemical-all.php?msg=' . $error . '&alert=success');
    } else {
        $error .= "Internal Server Error.";
        header('location: supplier-chemical-title-edit.php?id=' . $id . '&msg=' . $error . '&alert=danger');
    }
}
...
<head>
    <title>Edit Supplier Chemical Title - <?= BRANDNAME ?> Admin Panel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Supplier Chemical Title</h1>
                    </div>
                            ...
                            <form action="" method="post">
                                <div class="my-3">
                                    ...
                                    <div class="border rounded shadow p-3 my-3">
                                        <h3 class="mb-2">Edit Supplier Chemical Title</h3>
                                        <hr>
