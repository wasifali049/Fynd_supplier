...
$imageQuery = "SELECT * FROM `site_feedback` ORDER BY id DESC LIMIT $startFrom, $limit";
...
<head>
    <title>Manage Feedback Inquiry - <?= BRANDNAME ?> Admin Panel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Contact Feedback Management</h1>
                    </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td colspan="4">No Feedback Inquiry found!</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <div class="col-12 my-3">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm">
                                    ...
                                    $sql = "SELECT COUNT(*) FROM `site_feedback`";
                                    ...
                                    for ($i = 1; $i <= $total_pages; $i++) {
                                        if ($i == $pn) {
                                            $pagLink .= "<li class='page-item disabled active'><a class='page-link' href='feedback-inquiry.php?page="

                                                . $i . "'>" . $i . "</a></li>";
                                        } else {
                                            $pagLink .= "<li class='page-item'><a class='page-link' href='feedback-inquiry.php?page=" . $i . "'>
