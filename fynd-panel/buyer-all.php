...
if (isset($_REQUEST['searchSupplier']) && !empty($_REQUEST['searchSupplier'])) {
    ...
    $cond = "`name` LIKE '%{$searchSupplier}%' AND `user_type`='buyer'";
} else {
    $searchSupplier = '';
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Buyer Management</h1>
                    </div>
                        ...
                        <div class="col-md-8">
                            <form action="">
                                <div class="form-group d-flex justify-content-between">
                                    <input type="text" class="form-control" name="searchSupplier" placeholder="Search Buyer Name" value="<?= $searchSupplier ?>" required>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Buyer Title</th>
                                    <th scope="col">Buyer Cover Image</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="buyer-title-edit.php?id=<?= $buyerTitle->id ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                                            <i class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                                            Edit
                                        </a>
                                    </td>
                                    <td><?= $buyerTitle->title ?></td>
                                    <td>
                                        <img src="../assets/img/buyer/<?= $buyerTitle->cover ?>" class="card-img-top fixed-size" alt="...">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-12" style="width:100%;overflow: auto;">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th scope="col">Buyer Alignment</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="buyer-alignment-edit.php?id=<?= $buyerAlignment->id ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                                            <i class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                                            Manage Buyer Alignment
                                        </a>
                                    </td>
                                </tr>
                            </tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <a data-toggle="modal" data-target="#deleteModal" href="#" data-url="buyer-delete.php?id=<?= $value->id ?>" class="text-nowrap mx-1 my-1 btn btn-sm btn-danger image-delete-btn">
                                        ...
                                        <tr>
                                            <td colspan="4">No Buyer found!</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm">
                                    ...
                                    for ($i = 1; $i <= $total_pages; $i++) {
                                        if ($i == $pn) {
                                            $pagLink .= "<li class='page-item disabled active'><a class='page-link' href='buyer-all.php?page="

                                                . $i . "'>" . $i . "</a></li>";
                                        } else {
                                            $pagLink .= "<li class='page-item'><a class='page-link' href='buyer-all.php?page=" . $i . "'>
