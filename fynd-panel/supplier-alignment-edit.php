...
$model = fetch_all($db, "SELECT * FROM `user` WHERE user_type='supplier' AND status=1 ORDER BY id DESC");

$supplierAlignment = fetch_object($db, "SELECT * FROM `supplier_alignment` WHERE id='{$id}'");
...
if (isset($_POST['submit'])) {
    ...
    $s = "UPDATE `supplier_alignment` SET 
        `box1`='" . $box1 . "',
        `box2`='" . $box2 . "',
        `box3`='" . $box3 . "',
        `box4`='" . $box4 . "',
    ...
    if (mysqli_query($db, $s)) {
        $error .= "Supplier Alignment saved successfully";
        header('location: supplier-all.php?msg=' . $error . '&alert=success');
    } else {
        $error .= "Internal Server Error.";
        header('location: supplier-alignment-edit.php?id=' . $id . '&msg=' . $error . '&alert=danger');
    }
}
...
<head>
    <title>Add Supplier Alignment - <?= BRANDNAME ?> Admin Panel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Supplier Alignment Page</h1>
                    </div>

                    <div class="row my-4">
                        <div class="col-12">
                            <a href="./supplier-all.php" class="btn btn-primary btn-sm">
                            ...
                            <form action="" method="post">
                                <div class="my-3">
                                    ...
                                    <div class="border rounded shadow p-3 my-3">
                                        <h3 class="mb-2">Supplier Alignment</h3>
                                        <hr>
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box1" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey1 => $userVal1) {
                                                    ...
                                                    $selected1 = ($supplierAlignment->box1 == $userValue1->id) ? 'selected' : '';
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box2" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey2 => $userVal2) {
                                                    ...
                                                    $selected2 = ($supplierAlignment->box2 == $userValue2->id) ? 'selected' : '';
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box3" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey3 => $userVal3) {
                                                    ...
                                                    $selected3 = ($supplierAlignment->box3 == $userValue3->id) ? 'selected' : '';
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <select name="box4" class="form-control" required>
                                                ...
                                                foreach ($model as $userKey4 => $userVal4) {
                                                    ...
                                                    $selected4 = ($supplierAlignment->box4 == $userValue4->id) ? 'selected' : '';
