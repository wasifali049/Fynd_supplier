...
$model = fetch_object($db, "SELECT * FROM `quotation_title`");
...
if (isset($_POST['submit'])) {
    ...
    $s = "UPDATE `quotation_title` SET `title`='{$title}', `updated_at`='{$updated_at}' WHERE id='{$edit_id}'";

    if (mysqli_query($db, $s)) {
        $error .= "Quotation Inquiry Title Updated successfully.";
        header('location: quotation-all.php?msg=' . $error . '&alert=success');
    } else {
        $error .= "Internal Server Error.";
        header('location: quotation-title-edit.php?id=' . $id . '&msg=' . $error . '&alert=danger');
    }
}
...
<head>
    <title>Edit Quotation Inquiry Title - <?= BRANDNAME ?> Admin Panel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Quotation Inquiry Title</h1>
                    </div>

                    <div class="row my-4">
                        <div class="col-12">
                            <a href="./feedback-all.php" class="btn btn-primary btn-sm">
                            ...
                            <form action="" method="post">
                                <div class="my-3">
                                    ...
                                    <div class="border rounded shadow p-3 my-3">
                                        <h3 class="mb-2">Edit Quotation Inquiry Title</h3>
                                        <hr>
