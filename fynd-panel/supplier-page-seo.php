...
$sql = "SELECT * FROM `user` WHERE {$cond} ORDER BY id DESC LIMIT $startFrom, $limit";
...
<head>
    <title>Manage Supplier Page Seo - <?= BRANDNAME ?> Admin Panel</title>
                            ...
                            <div class="col-md-8">
                                <form action="">
                                    <div class="form-group d-flex justify-content-between">
                                        ...
                                        <a href="./supplier-page-seo.php" class="btn btn-danger">Clear</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="supplier-page-seo-update.php?id=<?= $chatValue->id ?>" class="mx-1 my-1 btn btn-sm btn-primary text-nowrap">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm">
                                    ...
                                    for ($i = 1; $i <= $total_pages; $i++) {
                                        if ($i == $pn) {
                                            $pagLink .= "<li class='page-item disabled active'><a class='page-link' href='supplier-page-seo.php?page="

                                                . $i . "'>" . $i . "</a></li>";
                                        } else {
                                            $pagLink .= "<li class='page-item'><a class='page-link' href='supplier-page-seo.php?page=" . $i . "'>
