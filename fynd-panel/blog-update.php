...
if (isset($_POST['submit'])) {
    ...
    if ($true == 1) {
        ...
        if (mysqli_query($db, $s)) {
            ...
            header('location: blog-view.php?id=' . $id . '&msg=' . $error . '&alert=success');
        } else {
            $error .= "Internal Server Error.";
            header('location: blog-view.php?id=' . $id . '&msg=' . $error . '&alert=danger');
        }
    } else {
        header('location: blog-view.php?id=' . $id . '&msg=' . $error . '&alert=danger');
    }
...
<head>
    <title>Update Blog - <?= BRANDNAME ?> Admin Panel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Blog Page</h1>
                    </div>

                    <div class="row my-4">
                        <div class="col-12">
                            <a href="./blog-view.php?id=<?= $id ?>" class="btn btn-primary btn-sm">
                                ...
                                <div class="my-3">
                                    ...
                                    <div class="border rounded shadow p-3 my-3">
                                        ...
                                        <div class="form-floating my-3">
                                            ...
                                            <input type="text" id="slug" class="form-control" name="slug" placeholder="Slug" value="<?= $model->slug ?>" required />
                                        </div>
                                        ...
                                        <div class="my-2">
                                            <img src="<?php echo $target_dir . $model->image ?>" style="width:100px">
                                        </div>
