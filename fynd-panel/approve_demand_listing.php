...
if (isset($_GET['id'])) {
    ...
    // 1. Update status to Verified in purchase_inquiries
    ...
    if ($update) {
        ...
        if ($result->num_rows > 0) {
            ...
            try {
                ...
                $mail->Subject = 'Your Demand Post Approved';
        ...
        // 4. Redirect to demand listings page
        // header("Location: admin_demand_listings.php?msg=approved");
        // exit;
        echo "<script>alert('Post approved and email sent successfully.'); window.location.href='admin_demand_listings.php';</script>";
        exit;
    } else {
