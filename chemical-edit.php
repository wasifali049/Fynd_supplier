...
$singleChemicalModel = fetch_object($db, "SELECT * FROM `chemical` WHERE id='{$model->chemical_id}'");
...
if (isset($_POST['submit'])) {
    ...
    if ($true == 1) {
        ...
        $s = "UPDATE `supplier_chemical_list` SET `product_specification`='{$product_specification}', `manufacturer_details`='{$manufacturer_details}', `chemical_id`='{$chemical_id}', `chemical_photo`='{$iName1}', `product_name`='{$product_name}', `min_order_quantity`='{$min_order_quantity}', `price`='{$price}', `density`='{$density}', `product_info`='{$product_info}', `updated_at`='{$created_at}' WHERE id='{$edit_id}'";
        ...
        if (mysqli_query($db, $s)) {
            ...
            header('location: chemical-add?&msg=' . $error . '&alert=danger');
        }
    } else {
        header('location: chemical-add?msg=' . $error . '&alert=danger');
    }
                        ...
                        <div class="card custom-card main-content-body-profile">
                            ...
                            <div class="card-header custom-card-header rounded-bottom-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="./profile?id=<?= $id ?>" class="oc-btn">Back</a>
                                </div>
                            </div>
                                            ...
                                            <div class="my-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <select class="form-select chemical-select-fields" id="inq-chemical" name="chemical" required>
                                                                ...
                                                                ?>
                                                                    <option value="<?= $chemicalValue2->chemical_name ?>" <?= ($singleChemicalModel->id == $chemicalValue2->id) ? 'selected' : '' ?>><?= $chemicalValue2->chemical_name ?></option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div>
                                                                ...
                                                                echo "<img width='100px' src='" . $target_dir . $model->chemical_photo . "' class='mt-1 img-responsive edit-avt-img img-thumbnail'>";
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="product_name" name="product_name" value="<?= $model->product_name ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                */ ?>
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="min_order_quantity" name="min_order_quantity" value="<?= $model->min_order_quantity ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="product_specification" name="product_specification" value="<?= $model->product_specification ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3" style="display:none">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label class="form-label website_label">Payment Term</label>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="density" name="density" value="<?= $model->density ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control" id="product_info" name="product_info" rows="4" required><?= $model->product_info ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control" id="manufacturer_details" name="manufacturer_details" rows="4" required><?= $model->manufacturer_details ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>


                                                <input type="hidden" value="<?= $model->id ?>" name="edit_id">
                                            </div>

                                            <div class="my-4 mx-auto text-center">
                                                <input type="submit" name="submit" class="btn btn-primary btn-block" value="UPDATE CHEMICAL" />
                                            </div>
                                        </form>
                                    </div>
                                </div>
