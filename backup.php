<!-- index.php backup old code ending line 2550 -->
<?php
...
<body>
    ...
    <section class="section banner-section pt-0 " style="background-color:white;">
        <div class="container-fluid ">
            <div class="row px-4">
                <div style="background-color:#F3F3F3;"
                    class="col-md-12 pt-2 banner-title banner-wrapper-1 main-heading-wrapper d-flex justify-content-between align-items-center flex-wrap">
                    <!-- <h3 class="p-0 landing-banner-heading">
                    ...
                    <div class="banner-main-btn" style = "background-color:#F3F3F3; color:black;">
                       <button style="border:none;"> <a aria-current="page" data-bs-toggle="modal" data-bs-target="#searchModel"
                            data-bs-whatever="buyer" >Send Inquiry/Offer</a> </button>
                        <!-- <a href="/membership.php" class="oc-btn">Upgrade</a> -->
                        <!-- <a aria-current="page" data-bs-toggle="modal" data-bs-target="#searchModel"
                                data-bs-whatever="offer" class="oc-btn">Send Offers to Buyers</a> -->
                    </div>
                </div>
                <div class="col-md-12 web_slideshow">
                    <div class="slideshow-container ">
                        <div class="mySlides slide">
                            ...
                            <img src="assets/img/banner/slide1.jpeg" style="width:100%">
                        </div>
                        <div class="mySlides slide">
                            <div class="numbertext">2 / 4</div>
                            <img src="assets/img/banner/slide2.jpeg" style="width:100%">
                        </div>
                        <div class="mySlides slide">
                            <div class="numbertext">3 / 4</div>
                            <img src="assets/img/banner/slide3.jpeg" style="width:100%">
                        </div>
                        <div class="mySlides slide">
                            <div class="numbertext">4 / 4</div>
                            <img src="assets/img/banner/slide4.jpeg" style="width:100%">
                ...
                <div class="col-md-12 mobile_slideshow">
                    <div class="slideshow-container ">
                        <div class="mySlidesmob slide">
                            <div class="numbertext">1 / 4</div>
                            <img src="assets/img/banner/slide1.png" style="width:100%">
                        </div>
                        <div class="mySlidesmob slide">
                            <div class="numbertext">2 / 4</div>
                            <img src="assets/img/banner/slide2.png" style="width:100%">
                        </div>
                        <div class="mySlidesmob slide">
                            <div class="numbertext">3 / 4</div>
                            <img src="assets/img/banner/slide3.png" style="width:100%">
                        </div>
                        <div class="mySlidesmob slide">
                            <div class="numbertext">4 / 4</div>
                            <img src="assets/img/banner/slide4.png" style="width:100%">
                            <!-- <div class="text">Caption Three</div> -->
                        </div>
                    </div>
                    <br>
                    ...
                    <script>
                        ...
                        function showSlidesmob() {
                            ...
                            slideIndexmob++;
                            if (slideIndexmob > slides.length) {
                                slideIndexmob = 1
                            }
                            for (i = 0; i < dots.length; i++) {
                                dots[i].className = dots[i].className.replace(" active", "");
